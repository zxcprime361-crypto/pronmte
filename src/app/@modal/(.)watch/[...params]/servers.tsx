  ...
  return [
    {
      ...
      movieLink: `https://api.zxcstream.xyz/player/movie/${id}?autoPlay=true`,
      tvLink: `https://api.zxcstream.xyz/player/tv/${id}/${season}/${episode}?autoPlay=true`,
      icon: <Tally1 />,
      value: "server1",
    },
    {
      ...
      movieLink: `https://api.zxcstream.xyz/embed/movie/${id}?autoPlay=true`,
      tvLink: `https://api.zxcstream.xyz/embed/tv/${id}/${season}/${episode}?autoPlay=true`,
